...
import { DocMsg, LinkMsg } from './Conversation/MessagesTypes';
...
const SharedMessages = () => {
  ...
  return (
    <Box sx={{width: 320, height: "100vh"}}>
      ...
      {/* Body */}
      <Stack className='scrollbar' sx={{height: "100%", position: "relative", flexGrow: 1, overflowY: "scroll"}} p={3} spacing={value === 1 ? 1 : 3}>
            ...
            <Grid container spacing={2}>
              {
                [0, 1, 2, 3, 4, 5, 6].map((el) => {
                  //we are going to render basically this grid item is basically going to contain that images we want to render
